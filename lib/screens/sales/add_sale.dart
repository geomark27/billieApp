...
class _AddSaleScreenState extends State<AddSaleScreen> {
  ...
  void initState() {
    ...
    orderDiscountType =
        context.read<CommonDataProvider>().selectOrderDiscountTypes[0]['value'];
    saleStatus =
        context.read<CommonDataProvider>().selectSaleStatusData[0]['value'];
    paymentStatus = context
        .read<CommonDataProvider>()
        .selectSalePaymentStatusData[0]['value'];
  }
  ...
  Future<void> handleSubmit() async {
    ...
    message = await SaleAPI.create(
      Sale(
        ...
        biller: context.read<CommonDataProvider>().billers[
            context.read<CommonDataProvider>().billers.indexWhere(
                  (t) => t.id.toString() == biller,
                )],
        customer: context.read<CommonDataProvider>().customers[
            context.read<CommonDataProvider>().customers.indexWhere(
                  (t) => t.id.toString() == customer,
                )],
    ...
    return FormScreen(
      ...
      children: [
        ...
        AppSelect(
          ...
          enableFilter: false,
          enableSearch: false,
          errorLine: message?.errors?['order_tax_rate'],
        ),
        AppSelect(
          hintText: "Order Discount Type",
          value: orderDiscountType,
          items: context.watch<CommonDataProvider>().selectOrderDiscountTypes,
          onChange: (value) {
            setState(() {
          ...
          enableFilter: false,
          enableSearch: false,
          errorLine: message?.errors?['order_discount_type'],
        ),
        AppInput(
          hintText: "Discount",
          ...
          errorLine: message?.errors?['order_discount'],
        ),
        AppInput(
        ...
        AppSelect(
          ...
          value: saleStatus,
          items: context.watch<CommonDataProvider>().selectSaleStatusData,
          onChange: (value) {
            setState(() {
              saleStatus = value;
            });
          ...
          enableFilter: false,
          enableSearch: false,
          errorLine: message?.errors?['sale_status'],
        ),
        AppSelect(
          hintText: "Payment Status",
          value: paymentStatus,
          items:
              context.watch<CommonDataProvider>().selectSalePaymentStatusData,
          onChange: (value) {
            setState(() {
              paymentStatus = value;
            });
          ...
          enableFilter: false,
          enableSearch: false,
          errorLine: message?.errors?['payment_status'],
        ),
        AppInput(
          hintText: "Sale Note",
          controller: saleNoteController,
          multiline: true,
          errorLine: message?.errors?['sale_note'],
        ),
        AppInput(
          hintText: "Staff Note",
          controller: staffNoteController,
          multiline: true,
          errorLine: message?.errors?['staff_note'],
        ),
        SizedBox(
