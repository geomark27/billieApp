...
class EditBarcodeStickerSettingScreen extends StatefulWidget {
  const EditBarcodeStickerSettingScreen({super.key});

  @override
  State<EditBarcodeStickerSettingScreen> createState() =>
      _EditBarcodeStickerSettingScreenState();
}

class _EditBarcodeStickerSettingScreenState
    extends State<EditBarcodeStickerSettingScreen> {
