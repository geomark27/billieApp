...
class AddDiscountPlanScreen extends StatefulWidget {
  const AddDiscountPlanScreen({super.key});

  @override
  State<AddDiscountPlanScreen> createState() => _AddDiscountPlanScreenState();
}

class _AddDiscountPlanScreenState extends State<AddDiscountPlanScreen> {
  ...
  Future<void> handleSubmit() async {
    ...
    message = await DiscountPlansAPI.create(
      DiscountPlan(
        id: 0,
